...
- [UX Basics](https://developers.google.com/web/fundamentals/design-and-ux/ux-basics/)
...
- [Web Typography 101](https://medium.com/@andreacrofts/web-typography-101-302af8a65be7)
- [Balancing line-height and font-size](https://www.smashingmagazine.com/2014/09/balancing-line-length-font-size-responsive-web-design/)
- [Responsive - REM global and EM local](https://css-tricks.com/rem-global-em-local/)
- [16px, anything else too small](https://www.smashingmagazine.com/2011/10/16-pixels-body-copy-anything-less-costly-mistake/)
...
- [Google resources](https://developers.google.com/web/progressive-web-apps/)
- [App Shel Pattern](https://developers.google.com/web/fundamentals/architecture/app-shell)


## OpenGraph (Facebook)

- [Quick Tutorial](https://davidwalsh.name/facebook-meta-tags)
- [Open Graph Protocol Specification](http://ogp.me/)
- [Facebook Sharing 101](https://developers.facebook.com/docs/sharing/webmasters)
- [Facebook Sharing Best Practices](https://developers.facebook.com/docs/sharing/best-practices/)


## Accessibility

- [Intro](https://developers.google.com/web/fundamentals/accessibility/)
